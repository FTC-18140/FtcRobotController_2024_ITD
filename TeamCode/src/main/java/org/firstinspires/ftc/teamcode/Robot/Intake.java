...
public class Intake {
    ...
    public final double SPROCKET_RATIO = 28.0/14.0; // We are using a 14-tooth drive sprocket and a 28-tooth driven sprocket
    public final double TICKS_PER_MOTOR_REV = 28.0;
    public final double TICKS_PER_ELBOW_REV = TICKS_PER_MOTOR_REV * ELBOW_GEAR_RATIO * SPROCKET_RATIO;
    public final double TICKS_PER_ELBOW_DEGREE = TICKS_PER_ELBOW_REV / 360.0;

    //public static double TICKS_PER_ELBOW_DEGREE = 5.96;
